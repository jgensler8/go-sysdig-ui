...
type EventsFilter struct {
	...
	ShowNotificationsDoNotFilterSameMetrics bool `json:"showNotificationsDoNotFilterSameMetrics,omitempty"`

	ShowNotificationsDoNotFilterSameScope bool `json:"showNotificationsDoNotFilterSameScope,omitempty"`
