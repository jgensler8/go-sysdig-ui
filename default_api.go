 ...
 *
 * @param dashboardInput DashboardInput
 * @return *DashboardInput
 */
func (a DefaultApi) CreateDashboard(dashboardInput DashboardInput) (*DashboardInput, *APIResponse, error) {
	...
	// body params
	localVarPostBody = &dashboardInput
	var successPayload = new(DashboardInput)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "CreateDashboard", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
...
func (a DefaultApi) DeleteDashboard(id int64) (*Dashboards, *APIResponse, error) {
	...
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/dashboards/{id}"
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "DeleteDashboard", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a DefaultApi) UpdateDashboard(dashboardInput DashboardInput, id int64) (*DashboardInput, *APIResponse, error) {
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "UpdateDashboard", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
